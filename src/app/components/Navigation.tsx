      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a 
              href="https://linkedin.com/in/martin" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-secondary hover:text-accent-primary transition-colors duration-300"
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-text-secondary hover:text-accent-primary transition-colors duration-300"
