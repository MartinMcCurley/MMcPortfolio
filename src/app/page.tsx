  ...
  return (
    <section id="projects" className="py-20 px-6 bg-bg-secondary">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-section font-semibold text-text-primary mb-4 text-center">
          Featured Projects
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.repoUrl} className="bg-bg-primary border border-border-subtle rounded-lg overflow-hidden hover:border-accent-primary transition-all duration-300 group">
...
export default function Home() {
  return (
    <div className="min-h-screen bg-bg-primary">
      {/* Navigation Header */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-bg-primary/90 backdrop-blur-sm border-b border-border-subtle">
      ...
      <main>
        {/* Hero Section */}
        <section id="hero" className="flex flex-col items-center justify-center min-h-screen px-6 text-center pt-20">
      ...
      <section id="about" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-section font-semibold text-text-primary mb-8 text-center">
            About Me
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="w-64 h-64 bg-bg-secondary border border-border-subtle rounded-lg flex items-center justify-center">
